        ...
        <v-container>
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="text-secondary" v-for="result in resultsAllNotCompleted" :key="result._id">
...
export default {
    ...
    data() {
        return {
            ...
            tokenRole: '',
            tokenId: '',
            resultsAllNotCompleted: undefined,
            orderId: '',
    ...
    methods: {
        ...
        async restaurantNotCompletedOrders() {
         ...
         async allNotCompletedOrders() {
            ...
            this.resultsAllNotCompleted = result.data
        },
